...
/**
 * This class calls PlayerDisconnectEvent and manages post actions.
 */
public class PlayerDisconnectEventCaller implements EventCaller {

    private ConnectionSocket socket;
    private PlayerDisconnectEvent event;

    public PlayerDisconnectEventCaller(ConnectionSocket socket, Packet packet) {
        this.socket = socket;
        this.event = (PlayerDisconnectEvent) EventAdapterManager.getEvent(socket, packet);
    }
